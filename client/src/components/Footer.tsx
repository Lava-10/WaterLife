    ...
    <footer className="bg-ocean-900 text-white mt-16">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">OceanPulse</h3>
            <p className="text-ocean-100">
              Join our mission to conserve water and protect our oceans.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-ocean-100 hover:text-white">Water Conservation Tips</a></li>
              <li><a href="#" className="text-ocean-100 hover:text-white">Marine Life Guide</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-ocean-100">Email: info@waterwise.com</li>
        ...
        <div className="border-t border-ocean-700 mt-8 pt-8 text-center text-ocean-100">
          <p>&copy; 2025 OceanPulse. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
